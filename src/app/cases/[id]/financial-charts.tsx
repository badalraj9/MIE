        ...
        return (
          <Card key={exhibit.id} className="overflow-hidden border-slate-200 shadow-sm">
            ...
            <CardContent className="p-5 pt-6 bg-white">
              {isChart ? (
                /* Fixed: explicit pixel height + min-w-0 prevents Recharts sizing bug */
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    {exhibit.chartType === "LINE" ? (
                      ...
                      >
                        ...
                        <Line type="monotone" dataKey="value" stroke="#0f172a" strokeWidth={2} dot={{ r: 4, fill: "#0f172a" }} activeDot={{ r: 6 }} />
                      </LineChart>
                    ) : (
                      <BarChart
                        data={parsedData}
